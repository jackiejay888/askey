...
@author: ron_chen
@title: Coding the customer.nl by sublime.
'''
import sys
import os
import time
...
class NL_Setting(unittest.TestCase):
	...
	def test_NL_Setting(self):
		print 'The test_NL_Setting function.'
		android.Check_Mobile_Note4()
		adbClient.Start_Airplane()
		rs232_putty.RS232_Disconnect_Putty()
		scp.SCP_Connection()
		scp.SCP_Upload('/mnt/flash/', customer_nl_local)
		ssh.SSH_Command('mv /mnt/flash/'+customer_nl_local +
